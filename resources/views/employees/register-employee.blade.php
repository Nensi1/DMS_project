    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('store.employees') }}">
                        @csrf
                                ...
                                <select name="position" class="form-control" id="position">
                                    <option value="">-- Select --</option>
                                        @foreach ($positions as $pos) 
                                            @if ($pos->title=== Auth::user()->position)
                                                <option disabled>{{ $pos->title }}</option>
                                            @elseif ($pos->title==="ADMIN")
                                                <option disabled>{{ $pos->title }}</option>
                                            @else 
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="wage" type="text" class="form-control{{ $errors->has('wage') ? ' is-invalid' : '' }}" name="wage" value="{{ old('wage') }}" required>
